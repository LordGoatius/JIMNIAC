...
pub mod test {
    ...
    fn test_enc_dec() {
        ...
        let vals = vec![
            ...
            BTI,
            RTI,
            LDRI(R12_WORD, R10_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            LDRR(R12_WORD, R10_WORD, RN11_WORD),
            LDRRI(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            LDRPCI(R12_WORD, [[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            STRI(R12_WORD, R10_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            STRR(R12_WORD, R10_WORD, RN11_WORD),
            STRRI(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            STRPCI(R12_WORD, [[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            MOVRR(R12_WORD, R10_WORD),
            MOVRI(R12_WORD, [[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            OWO([[Trit::Zero, Trit::POne, Trit::NOne]; 3].into(), R12_WORD, R10_WORD),
            UWU([[Trit::Zero, Trit::POne, Trit::NOne]; 3].into(), R12_WORD, R10_WORD),
            ADD(R12_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into(), R10_WORD, RN11_WORD),
            MUL(R12_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into(), R10_WORD, RN11_WORD),
            SUB(R12_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into(), R10_WORD, RN11_WORD),
            EQOT(R12_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into(), R10_WORD, RN11_WORD),
            EREM(R12_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into(), R10_WORD, RN11_WORD),
            NOT(R12_WORD, R10_WORD),
            LSH(R12_WORD, R10_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            RSH(R12_WORD, R10_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            ANDR(R12_WORD, R10_WORD, RN11_WORD),
            ORR(R12_WORD, R10_WORD, RN11_WORD),
            ROTR(R12_WORD, R10_WORD, RN11_WORD),
            ROTI(R12_WORD, R10_WORD, [[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            PUSHR3(R12_WORD, R10_WORD, RN11_WORD),
            ...
            PUSHMEM(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            POP(R12_WORD),
            CMP(R12_WORD, R10_WORD),
            SPT(R12_WORD),
            SST(R12_WORD),
            BRR(R12_WORD, R10_WORD, RN11_WORD),
            BRI([[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            BRM(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            BNER(R12_WORD, R10_WORD, RN11_WORD),
            BNEI([[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            BNEM(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            BGTR(R12_WORD, R10_WORD, RN11_WORD),
            BGTI([[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            BGTM(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            BLTR(R12_WORD, R10_WORD, RN11_WORD),
            BLTI([[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            BLTM(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            BEQR(R12_WORD, R10_WORD, RN11_WORD),
            BEQI([[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            BEQM(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            BGEQR(R12_WORD, R10_WORD, RN11_WORD),
            BGEQI([[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            BGEQM(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            BLEQR(R12_WORD, R10_WORD, RN11_WORD),
            BLEQI([[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            BLEQM(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            BOFNR(R12_WORD, R10_WORD, RN11_WORD),
            BOFNI([[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            BOFNM(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            BOFZR(R12_WORD, R10_WORD, RN11_WORD),
            BOFZI([[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            BOFZM(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            BOFPR(R12_WORD, R10_WORD, RN11_WORD),
            BOFPI([[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            BOFPM(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            BPNR(R12_WORD, R10_WORD, RN11_WORD),
            BPNI([[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            BPNM(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            BPZR(R12_WORD, R10_WORD, RN11_WORD),
            BPZI([[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            BPZM(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            BPPR(R12_WORD, R10_WORD, RN11_WORD),
            BPPI([[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            BPPM(R12_WORD, R10_WORD, RN11_WORD, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            INR(R12_WORD, R10_WORD),
            OUTR(R12_WORD, R10_WORD),

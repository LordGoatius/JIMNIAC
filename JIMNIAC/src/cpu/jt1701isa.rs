...
pub mod test {
    ...
    fn test_enc_dec() {
        ...
        let vals = vec![
            ...
            BTI,
            RTI,
            LDRI(R12, R10, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            LDRR(R12, R10, RN11),
            LDRRI(R12, R10, RN11, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            LDRPCI(R12, [[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            STRI(R12, R10, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            STRR(R12, R10, RN11),
            STRRI(R12, R10, RN11, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            STRPCI(R12, [[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            MOVRR(R12, R10),
            MOVRI(R12, [[Trit::Zero, Trit::POne, Trit::NOne], [Trit::POne, Trit::NOne, Trit::Zero], ZERO, ZERO, ZERO, ZERO, ZERO, ZERO, ZERO].into()),
            OWO([[Trit::Zero, Trit::POne, Trit::NOne]; 3].into(), R12, R10),
            UWU([[Trit::Zero, Trit::POne, Trit::NOne]; 3].into(), R12, R10),
            ADD(R12, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into(), R10, RN11),
            MUL(R12, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into(), R10, RN11),
            SUB(R12, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into(), R10, RN11),
            EQOT(R12, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into(), R10, RN11),
            EREM(R12, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into(), R10, RN11),
            NOT(R12, R10),
            LSH(R12, R10, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            ...
            PUSHMEM(R12, R10, RN11, [[Trit::Zero, Trit::POne, Trit::NOne]; 3].into()),
            POP(R12),
            CMP(R12, R10),
            SPT(R12),
            SST(R12),

...
impl From<TERSCII> for Tryte {
    fn from(value: TERSCII) -> Self {
        match value {
            TERSCII::NULL => [Z, Z, Z].into(),
            TERSCII::LE => [Z, Z, Y].into(),
            TERSCII::ESC => [Z, Z, X].into(),
            TERSCII::LR => [Z, Z, W].into(),
            TERSCII::OP => [Z, Z, V].into(),
            TERSCII::SU => [Z, Z, U].into(),
            TERSCII::SD => [Z, Z, T].into(),
            TERSCII::SP => [Z, Z, S].into(),
            TERSCII::ACK => [Z, Z, R].into(),
            TERSCII::NACK => [Z, Z, Q].into(),
            TERSCII::RT => [Z, Z, P].into(),
            TERSCII::TAB => [Z, Z, O].into(),
            TERSCII::Period => [Z, Z, N].into(),
            TERSCII::Zero => [Z, Z, ZERO].into(),
            TERSCII::One => [Z, Z, A].into(),
            TERSCII::Two => [Z, Z, B].into(),
            TERSCII::Three => [Z, Z, C].into(),
            TERSCII::Four => [Z, Z, D].into(),
            TERSCII::Five => [Z, Z, E].into(),
            TERSCII::Six => [Z, Z, F].into(),
            TERSCII::Seven => [Z, Z, G].into(),
            TERSCII::Eight => [Z, Z, H].into(),
            TERSCII::Nine => [Z, Z, I].into(),
            TERSCII::Exclamation => [Z, Z, J].into(),
            TERSCII::Question => [Z, Z, K].into(),
            TERSCII::Minus => [Z, Z, L].into(),
            TERSCII::Plus => [Z, Z, M].into(),
            TERSCII::A => [Z, Y, Z].into(),
            TERSCII::B => [Z, Y, Y].into(),
            TERSCII::C => [Z, Y, X].into(),
            TERSCII::D => [Z, Y, W].into(),
            TERSCII::E => [Z, Y, V].into(),
            TERSCII::F => [Z, Y, U].into(),
            TERSCII::G => [Z, Y, T].into(),
            TERSCII::H => [Z, Y, S].into(),
            TERSCII::I => [Z, Y, R].into(),
            TERSCII::J => [Z, Y, Q].into(),
            TERSCII::K => [Z, Y, P].into(),
            TERSCII::L => [Z, Y, O].into(),
            TERSCII::M => [Z, Y, N].into(),
            TERSCII::N => [Z, Y, ZERO].into(),
            TERSCII::O => [Z, Y, A].into(),
            TERSCII::P => [Z, Y, B].into(),
            TERSCII::Q => [Z, Y, C].into(),
            TERSCII::R => [Z, Y, D].into(),
            TERSCII::S => [Z, Y, E].into(),
            TERSCII::T => [Z, Y, F].into(),
            TERSCII::U => [Z, Y, G].into(),
            TERSCII::V => [Z, Y, H].into(),
            TERSCII::W => [Z, Y, I].into(),
            TERSCII::X => [Z, Y, J].into(),
            TERSCII::Y => [Z, Y, K].into(),
            TERSCII::Z => [Z, Y, L].into(),
            TERSCII::ADD_27_PREV => [Z, Y, M].into(),
            TERSCII::a => [Z, X, Z].into(),
            TERSCII::b => [Z, X, Y].into(),
            TERSCII::c => [Z, X, X].into(),
            TERSCII::d => [Z, X, W].into(),
            TERSCII::e => [Z, X, V].into(),
            TERSCII::f => [Z, X, U].into(),
            TERSCII::g => [Z, X, T].into(),
            TERSCII::h => [Z, X, S].into(),
            TERSCII::i => [Z, X, R].into(),
            TERSCII::j => [Z, X, Q].into(),
            TERSCII::k => [Z, X, P].into(),
            TERSCII::l => [Z, X, O].into(),
            TERSCII::m => [Z, X, N].into(),
            TERSCII::n => [Z, X, ZERO].into(),
            TERSCII::o => [Z, X, A].into(),
            TERSCII::p => [Z, X, B].into(),
            TERSCII::q => [Z, X, C].into(),
            TERSCII::r => [Z, X, D].into(),
            TERSCII::s => [Z, X, E].into(),
            TERSCII::t => [Z, X, F].into(),
            TERSCII::u => [Z, X, G].into(),
            TERSCII::v => [Z, X, H].into(),
            TERSCII::w => [Z, X, I].into(),
            TERSCII::x => [Z, X, J].into(),
            TERSCII::y => [Z, X, K].into(),
            TERSCII::z => [Z, X, L].into(),
            TERSCII::SUB_27_PREV => [Z, X, M].into(),

            TERSCII::ACCENTS_00 => [Z, W, Z].into(),
            TERSCII::ACCENTS_01 => [Z, W, Y].into(),
            TERSCII::ACCENTS_02 => [Z, W, X].into(),
            TERSCII::ACCENTS_03 => [Z, W, W].into(),
            TERSCII::ACCENTS_04 => [Z, W, V].into(),
            TERSCII::ACCENTS_05 => [Z, W, U].into(),
            TERSCII::ACCENTS_06 => [Z, W, T].into(),
            TERSCII::ACCENTS_07 => [Z, W, S].into(),
            TERSCII::ACCENTS_08 => [Z, W, R].into(),
            TERSCII::ACCENTS_09 => [Z, W, Q].into(),
            TERSCII::ACCENTS_10 => [Z, W, P].into(),
            TERSCII::LPAREN => [Z, W, O].into(),
            TERSCII::RPAREN => [Z, W, N].into(),
            TERSCII::LBRACE => [Z, W, ZERO].into(),
            TERSCII::RBRACE => [Z, W, A].into(),
            TERSCII::LBRACK => [Z, W, B].into(),
            TERSCII::RBRACK => [Z, W, C].into(),
            TERSCII::VERT => [Z, W, D].into(),
            TERSCII::UNDERSCORE => [Z, W, E].into(),
            TERSCII::DQUOTE => [Z, W, F].into(),
            TERSCII::SQUOTE => [Z, W, G].into(),
            TERSCII::TICK => [Z, W, H].into(),
            TERSCII::LANGLE => [Z, W, I].into(),
            TERSCII::RANGLE => [Z, W, J].into(),
            TERSCII::EQUAL => [Z, W, K].into(),
            TERSCII::SEMICOLON => [Z, W, L].into(),
            TERSCII::ASTERISK => [Z, W, M].into(),
            TERSCII::SLASH => [Z, V, Z].into(),
            TERSCII::BSLASH => [Z, V, Y].into(),
            TERSCII::COLON => [Z, V, X].into(),
            TERSCII::AT => [Z, V, W].into(),
            TERSCII::HASH => [Z, V, V].into(),
            TERSCII::DOLLAR => [Z, V, U].into(),
            TERSCII::PERCENT => [Z, V, T].into(),
            TERSCII::CARET => [Z, V, S].into(),
            TERSCII::AMP => [Z, V, R].into(),
            TERSCII::TILDE => [Z, V, Q].into(),
            TERSCII::COMMA => [Z, V, P].into(),
            TERSCII::CORNER_NW => [Z, V, O].into(),
            TERSCII::CORNER_NE => [Z, V, N].into(),
            TERSCII::CORNER_SE => [Z, V, ZERO].into(),
            TERSCII::CORNER_SW => [Z, V, A].into(),
            TERSCII::HORIZ_LINE => [Z, V, B].into(),
            TERSCII::T_DOWNSIDE => [Z, V, C].into(),
            TERSCII::T_UPSIDE => [Z, V, D].into(),
            TERSCII::T_EAST => [Z, V, E].into(),
            TERSCII::T_WEST => [Z, V, F].into(),
            TERSCII::VERT_LINE => [Z, V, G].into(),
            TERSCII::CROSS_LINE => [Z, V, H].into(),
            TERSCII::ROUNDED_NW => [Z, V, I].into(),
            TERSCII::ROUNDED_NE => [Z, V, J].into(),
            TERSCII::ROUNDED_SE => [Z, V, K].into(),
            TERSCII::ROUNDED_SW => [Z, V, L].into(),
            TERSCII::NULLSET => [Z, V, M].into(),
        }
    }
}

impl From<TERSCII> for Word {
    fn from(value: TERSCII) -> Self {
        let tryte: Tryte = value.into();
        tryte.into()
    }
}
